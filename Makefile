...
CCFLAGS = -O1 -Wall -march=native --std=c++11 -funroll-loops --param max-unroll-times=4 -ftree-vectorizer-verbose=3 -ftree-vectorize -ftree-slp-vectorize -fopenmp -fopenmp-simd
